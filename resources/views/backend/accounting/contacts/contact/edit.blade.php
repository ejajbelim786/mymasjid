    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="header-title mb-0">{{ _lang('Update Member') }}</h4>
                <p class="mb-0">Unique Member ID (UID): <b>{{ $contact->uin}}</b></p>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">{{ _lang('Member Phone') }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="category_id" id="category">
                                    ...
                                    @foreach($categories as $key => $value)
                                        <option value="{{ $key }}" {{ $contact->category_id == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="subcategory_id" id="subcategory">
                                    ...
                                    @foreach($subcategories as $key => $value)
                                        <option value="{{ $key }}" {{ $contact->subcategory_id == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control dropify" name="contact_image"
                                    ...
                                    data-default-file="{{ asset('uploads/contacts/'.$contact->contact_image) }}">
                            </div>
                        </div>
                    </div>
                </div>
