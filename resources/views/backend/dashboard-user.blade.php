  ...
  <!---  <div class="col-xl-3 col-md-6">
   ...
   <div class="col-xl-3 col-md-6">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-4">
            <div class="card-body">
                <h5>{{ _lang('Yearly Income') }}</h5>
                <h6 class="pt-1"><b>{{ decimalPlace($current_year_income, $currency) }}</b></h6>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mb-4">
            <div class="card-body">
                <h5>{{ _lang('Yearly Expense') }}</h5>
                <h6 class="pt-1"><b>{{ decimalPlace($current_year_expense, $currency) }}</b></h6>
            </div>
        </div>
    </div>
</div>
