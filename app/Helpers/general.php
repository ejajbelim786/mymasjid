...
if (!function_exists('get_category_name')) {
    function get_category_name($category_id) {
        return DB::table('categories')->where('id', $category_id)->value('name') ?? 'N/A';
    }
}

if (!function_exists('get_subcategory_name')) {
    function get_subcategory_name($subcategory_id) {
        return DB::table('subcategories')->where('id', $subcategory_id)->value('name') ?? 'N/A';
    }
}
...
if (!function_exists('current_year_income')) {
...
if (!function_exists('current_year_expense')) {

    function current_year_expense() {
